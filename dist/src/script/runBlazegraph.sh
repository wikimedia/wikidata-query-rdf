...
OAUTH_SESSION_STORE_HOSTNAME=${OAUTH_SESSION_STORE_HOSTNAME:-""}
OAUTH_SESSION_STORE_PORT=${OAUTH_SESSION_STORE_PORT:-""}
OAUTH_SESSION_STORE_KEY_PREFIX=${OAUTH_SESSION_STORE_KEY_PREFIX:-""}
