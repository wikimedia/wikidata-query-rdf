...
case class MeasureEventProcessingLatencyOperation(clock: Clock) extends RichMapFunction[MutationDataChunk, MutationDataChunk] {
  ...
  override def map(op: MutationDataChunk): MutationDataChunk = {
